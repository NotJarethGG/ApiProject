...
namespace Dta.Migrations
{
    ...
    [Migration("20230520005812_HabilidadMigration")]
    partial class HabilidadMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dta.Models.FormacionAcademica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dta.Models.Oferta", b =>
                {
                    ...
                    b.Property<string>("PaginaWebDeLaEmpresa")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Dta.Models.Oferta", b =>
                {
                    b.HasOne("Dta.Models.Empresa", null)
                        .WithMany("Ofertas")
